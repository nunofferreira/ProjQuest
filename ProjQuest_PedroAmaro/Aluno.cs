...
namespace QUEST
{
    public class Aluno
    {
        ...
        {
            var alunos = GetAlunosJson(@"..\..\..\J\Alunos\alunos.json");
            ...
            Serealize(@"..\..\..\J\Alunos\alunos.json", alunos);

            var listalunos = GetAlunosJson(@"..\..\..\J\Alunos\alunos.json");
        ...
        public static List<Aluno> GetAlunosJson(string path)
        {
            ...
            var alunos = JsonSerializer.Deserialize<List<Aluno>>(jsonQuestions); 
        ...
        {
            var testesDisponiveis = Teste.GetTestesJson(@"..\..\..\J\Testes\testes.json");
                ...
                switch (pergunta.Tipo)
                {
                    case 1:
                        ...
                        if (getteste.PergRespRandom == 1)
                        {
                            ...
                            {
                                string respostaUserCB = respostasRndCB.ElementAt(item - 1); ///////resposta do user String
            ...
            var alunosJson = Aluno.GetAlunosJson(@"..\..\..\J\Alunos\alunos.json");

            alunosJson.RemoveAll(x => x.ID == aluno.ID);

            alunosJson.Add(aluno);

            Serealize(@"..\..\..\J\Alunos\alunos.json", alunosJson);
