...
namespace QUEST
{
    public class Questions
    {
        ...
        public static void NewQuestion()
        {
            ...
            var questions1 = GetQuestionsJson(@"..\..\..\J\perguntas\questions.json");
            ...
            int getsubjet = Func.ReadInt("1 - Cultura Geral \n2 - Musica \n3 - Cultura Geral");
            Console.Clear();
            ...
            while (getsubjet > 3 || getsubjet < 1)
            {
                Console.WriteLine("Digite uma opção válida por favor");
                Console.WriteLine();
                getsubjet = Func.ReadInt("1 - Cultura Geral n2 - Musica \n3 - Cultura Geral");
                Console.Clear();
            }
        ...
        public static void QuestionAnswer(List<Questions> questions1, int getsubjet, int getlevel, string gettag, int getifonlyquest)
        {
            ...
            if (gettype == 1)
            {
                ...
                Questions.Serealize(@"..\..\..\J\perguntas\questions.json", questions1);
