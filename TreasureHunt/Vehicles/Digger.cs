...
{
    public Digger() : base(ConsoleColor.Yellow, "D", "Digger")
    {
    ...
    public override void MoveNorth()
    {
        ...
        var alternativeDestination = new Coordinate(Forest.Terrain.GetLength(0) - 2, Coordinates.Column);
        Move(destination, alternativeDestination);
    }
    public override void MoveSouth()
    {
        var destination = new Coordinate(Coordinates.Row + 1, Coordinates.Column);
        var alternativeDestination = new Coordinate(1, Coordinates.Column);
        Move(destination, alternativeDestination);
    }
    ...
    public override void MoveEast()
    {
        ...
        var alternativeDestination = new Coordinate(Coordinates.Row, 1);
        Move(destination, alternativeDestination);
    }
    ...
    {
        var destination = new Coordinate(Coordinates.Row, Coordinates.Column - 1);
        var alternativeDestination = new Coordinate(Coordinates.Row, Forest.Terrain.GetLength(1) - 2);
        Move(destination, alternativeDestination);
    }
